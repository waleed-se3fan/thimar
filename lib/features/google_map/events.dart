...
class AddNewLocationEvent extends GoogleMapEvent {
  ...
  double long;
  String location;
  AddNewLocationEvent(this.type, this.phone, this.description, this.latit,
      this.long, this.location);
}
...
class UpdateLocationEvent extends GoogleMapEvent {
  ...
  UpdateLocationEvent(this.id, this.type, this.description, this.phone,
      this.lat, this.lng, this.location);
}
